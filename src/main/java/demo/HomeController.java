...
//	}
	...
	public String registerNewUser(@RequestParam("username") String username, 
		...
		try {
			...
			String confirmLink = "https://ckj13-zavad.herokuapp.com/confirm?token=" + token.getValue();
	...
	public String remind(@RequestParam("username") String username, 
		...
		try {
			...
			String newPwd = "https://ckj13-zavada.herokuapp.com/confirmPwd?token=" + token2.getValue();
