...
async function searchNotes() {
	...
	console.log(word)
	for (note of notes) {
		if ((((note.title).toLowerCase()).includes(word)) || (((note.message).toLowerCase()).includes(word)) ) {
	...
	let divN = document.getElementById("notesid")

	let divcont = document.createElement("div")
	divcont.classList.add("containerNotes")
	divN.appendChild(divcont)
	...
	document.querySelector("body").appendChild(divN)
